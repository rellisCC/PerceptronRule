window.SAMPLE_DATASETS = [
  {
    ...
    cases: [
      { ID:"RA", Text:"You know the pizza place is bad when even the breadsticks are bad.", feat1:0, feat2:2, label:0 },
      ...
      { ID:"RD", Text:"Even though this is in the best location, the management is simply bad.", feat1:1, feat2:1, label:0 },
