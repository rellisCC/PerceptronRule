window.SAMPLE_DATASETS = [
  {
    ...
    cases: [
      { ID:"RA", Text:"Mama’s has the best pizza in Pittsburg, if not the entire country.", feat1:1, feat2:0, label: 1 },
      { ID:"RB", Text:"I had a bad experience at Mama’s pizza when I ordered pepperoni but they delivered pineapple", feat1:0, feat2:1, label:0 },
      { ID:"RC", Text:"I had the best birthday ever since I got to eat the best pizza from Mama’s.", feat1:2, feat2:0, label: 1 },
      { ID:"RD", Text:"You know the pizza place is bad when even the breadsticks are bad.", feat1:0, feat2:2, label:0 },
      { ID:"RE", Text:"Even though this is in the best location, the management is simply bad.", feat1:1, feat2:1, label:0 },
